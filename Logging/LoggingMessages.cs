...
public static partial class LoggingMessages
    {
        ...
        [LoggerMessage(925, LogLevel.Error, "Http Exception thrown getting page == {message}")]
        public static partial void LogHttpException(this ILogger logger, string message);
